...
Join us to meet other local computer scientists. All levels are welcomed.", city_name: "San Francisco", image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484353544/compsc_n2ryhb.png")
...
Meet other local evolutionists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484632895/evolution-wide-wallpaper-20363_de3u4z.jpg")

group3 = Group.create!(title: 'Bioinformaticians', description: 'Bioinformatics is an interdisciplinary field that develops methods and software tools for understanding biological data. As an interdisciplinary field of science, bioinformatics combines computer science, statistics, mathematics, and engineering to analyze and interpret biological data. Bioinformatics has been used for in silico analyses of biological queries using mathematical and statistical techniques. Join us to meet other local bioinformaticians. All levels are welcomed.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484353334/Unknown-4_zgxs42.jpg")
...
Join us to meet other local geneticists. All levels are welcomed.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484353117/genetics-at-work2_hzyzrf.jpg")
...
Meet other local astronomists to discuss the latest news and theories.", city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484902582/nue8nu3otjo-nasa_kg2tsg.jpg")
...
Meet other local cosmologists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484902642/isyylt2rkac-thom-schneider_kbat1j.jpg")
...
Meet other local data scientists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484760850/68zlatavyio-markus-spiske_hdmbmc.jpg")
...
Meet other local physicists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484761264/pod5oldjqmq-sidney-perry_nv6hug.jpg")
...
Meet other local mathematicians to discuss theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484902947/AAEAAQAAAAAAAAUgAAAAJDlkZjBjNTVjLTVjYjAtNDgwZS05Y2FmLWRlNzdmMWY4YWVhMA_a9xmaa.jpg")
...
Meet other local chemists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484942952/periodic-table-1626299_1280_g9bjvb.png")
...
Meet other local astrophysicists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484943196/exoplanet-571900_1280_x1hrph.jpg")
...
Meet other local biochemists to discuss the latest news and theories.', city_name: 'San Francisco', image_url: "https://res.cloudinary.com/datsbxfvs/image/upload/v1484943446/download_su01jr.jpg")




user1 = User.create!(username: 'Guest', email: 'guest@email.com', password:'password', show_email: false)
user2 = User.create!(username: 'Kendall', email: 'kendall@email.com', password:'password', show_email: false)
user3 = User.create!(username: 'Anton', email: 'anton@email.com', password:'password', show_email: false)
user4 = User.create!(username: 'Riaz', email: 'riaz@email.com', password:'password', show_email: false)
user5 = User.create!(username: 'Nilam', email: 'nilam@email.com', password:'password', show_email: false)
user6 = User.create!(username: 'Mattithiah', email: 'mattithiah@email.com', password:'password', show_email: false)
user7 = User.create!(username: 'Daminus', email: 'daminus@email.com', password:'password', show_email: false)
user8 = User.create!(username: 'Gael', email: 'gael@email.com', password:'password', show_email: false)
user9 = User.create!(username: 'Ken', email: 'ken@email.com', password:'password', show_email: false)
user10 = User.create!(username: 'Antony', email: 'antony@email.com', password:'password', show_email: false)
user11 = User.create!(username: 'Riza', email: 'riza@email.com', password:'password', show_email: false)
user12 = User.create!(username: 'Neil', email: 'neil@email.com', password:'password', show_email: false)
user13 = User.create!(username: 'Matt', email: 'matt@email.com', password:'password', show_email: false)
user14 = User.create!(username: 'Daniel', email: 'daniel@email.com', password:'password', show_email: false)
user15 = User.create!(username: 'Hugh', email: 'hugh@email.com', password:'password', show_email: false)
user16 = User.create!(username: 'Rachel', email: 'rachel@email.com', password:'password', show_email: false)
user17 = User.create!(username: 'John', email: 'john@email.com', password:'password', show_email: false)
user18 = User.create!(username: 'Marc', email: 'marc@email.com', password:'password', show_email: false)
user19 = User.create!(username: 'Claire', email: 'claire@email.com', password:'password', show_email: false)
user20 = User.create!(username: 'Charlene', email: 'charlene@email.com', password:'password', show_email: false)
user21 = User.create!(username: 'Brad', email: 'brad@email.com', password:'password', show_email: false)
user22 = User.create!(username: 'Jack', email: 'jack@email.com', password:'password', show_email: false)
user23 = User.create!(username: 'Chloe', email: 'chloe@email.com', password:'password', show_email: false)
user24 = User.create!(username: 'Hakan', email: 'hakan@email.com', password:'password', show_email: false)
user25 = User.create!(username: 'Alara', email: 'alara@email.com', password:'password', show_email: false)
user26 = User.create!(username: 'Arel', email: 'arel@email.com', password:'password', show_email: false)
user27 = User.create!(username: 'Aron', email: 'aron@email.com', password:'password', show_email: false)
user28 = User.create!(username: 'Berk', email: 'berk@email.com', password:'password', show_email: false)
user29 = User.create!(username: 'Jess', email: 'jess@email.com', password:'password', show_email: false)
user30 = User.create!(username: 'Scotch', email: 'scotch@email.com', password:'password', show_email: false)
