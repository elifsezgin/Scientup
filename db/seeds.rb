...
Participation.create!(user_id: user8.id, event_id: 1)
...
Participation.create!(user_id: user8.id, event_id: 2)
...
Participation.create!(user_id: user8.id, event_id: 5)
...
Participation.create!(user_id: user8.id, event_id: 7)
