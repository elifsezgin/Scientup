...
ActiveRecord::Schema.define(version: 20170120190456) do
  ...
  add_index "event_hostings", ["event_id"], name: "index_event_hostings_on_event_id", using: :btree
  add_index "event_hostings", ["user_id", "event_id"], name: "index_event_hostings_on_user_id_and_event_id", using: :btree
  add_index "event_hostings", ["user_id"], name: "index_event_hostings_on_user_id", using: :btree
